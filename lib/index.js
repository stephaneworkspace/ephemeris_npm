...
import { Ascendant } from 'ascendantastrologyspecial'
...
function getAllPlanets (iDate, geodeticalLongitude, geodeticalLatitude, height) {
    ...
    let asc = new Ascendant(1, '1986-04-03', '04:54');
    let ascSigne = +test.getAscendant().signeTypeAsc;
    let ascDegre = test.getAscendant().degre;
